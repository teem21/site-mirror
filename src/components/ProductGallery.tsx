...
const ProductGallery = () => {
  ...
  return (
    <section className="py-20 px-6 lg:px-16 bg-primary-foreground">
      <div className="max-w-6xl my-0 mx-0 rounded-none shadow-none">
        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_auto]">
          ...
          <div className="overflow-hidden border border-border bg-background">
            <img
              ...
              className="aspect-[4/3] w-full object-cover transition-all duration-500 border border-none rounded-none" />
